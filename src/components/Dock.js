...
export default function Dock({ windows, focusByCharge, launchOpen }) {
    return <div className="bg-[rgba(0,0,0,0.5)] backdrop-blur-sm text-white w-fit self-center items-center p-2 flex rounded-t-md shadow-sm shadow-[rgba(0,0,0,0.15)] border border-[rgba(0,0,0,0.15)]">
