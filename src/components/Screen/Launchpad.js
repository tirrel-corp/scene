...
export default function Launchpad({ apps, children, focusByCharge, launchOpen }) {
    ...
    return <div className="w-full h-full z-[1000] flex justify-center items-center transition-all">
        <div
            className={cn("bg-[rgba(0,0,0,0.7)] shadow-md shadow-[rgba(0,0,0,0.1)] w-full h-full max-w-[1024px] max-h-[80vh] z-[1000] rounded-xl m-4 flex flex-col items-center justify-center backdrop-blur-sm transition-all ease-in-out p-6",
